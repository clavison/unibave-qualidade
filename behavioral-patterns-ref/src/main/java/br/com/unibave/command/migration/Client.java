package br.com.unibave.command.migration;

import java.util.LinkedHashMap;
import java.util.List;
import java.util.Map;

import br.com.unibave.command.migration.commands.ProductTable;
import br.com.unibave.command.migration.commands.UserTable;
import br.com.unibave.command.migration.commands.UserTableRoleColumn;

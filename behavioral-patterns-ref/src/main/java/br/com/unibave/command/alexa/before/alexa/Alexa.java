package br.com.unibave.command.alexa.before.alexa;

import java.util.HashMap;
import java.util.Map;

import br.com.unibave.command.alexa.before.lights.PhillipsHueLight;
import br.com.unibave.command.alexa.before.lights.XiaomiLight;
